...
### Generator
At first you need the [src/](src) folder from github.  In your `build.properties` you need
...
all its features.
Include the [src/runtime/ListenerBehavior.php](src/runtime/ListenerBehavior.php) file in your
source code.
